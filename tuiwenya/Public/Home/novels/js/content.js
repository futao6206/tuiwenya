...
$(document).ready(function () {
    ...
    function load_title(data) {
        page_title.html(data.name + " - tuiwenya");
    }
    ...
    function load_btn_href(data) {
        page_btn_pre.attr("href", "/tuiwenya_content?url=" + data.pre_chapter_url + "&chapter_url=" + data.chapter_url + "&novels_name=" + data.novels_name);
        page_btn_next.attr("href", "/tuiwenya_content?url=" + data.next_chapter_url + "&chapter_url=" + data.chapter_url + "&novels_name=" + data.novels_name);
    }

    function load_location_url(data) {
        var th_url = window.location.href + "";
        var pos = th_url.indexOf("/tuiwenya_content?");
        var td_url = "/tuiwenya_content?url=" + data.url + "&name=" + data.name + "&chapter_url=" + data.chapter_url + "&novels_name=" + data.novels_name;
        th_url += td_url;
        //log(th_url);
        window.history.replaceState({}, data.name + " - tuiwenya", td_url);
    }
